            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : recordEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="record-filial" type="text" name="filial" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  ...
                  <AvField id="record-strahovoySluchay" type="text" name="strahovoySluchay" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  ...
                  <AvField id="record-fioClient" type="text" name="fioClient" />
                </AvGroup>
                <AvGroup>
                  ...
                  <AvField id="record-passportClient" type="text" name="passportClient" />
                </AvGroup>
                <AvGroup>
                  ...
                  <AvField id="record-telephoneClient" type="text" name="telephoneClient" />
                </AvGroup>
                <AvGroup>
                  ...
                  <AvField id="record-addressClient" type="text" name="addressClient" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  ...
                  <AvField id="record-fioAgent" type="text" name="fioAgent" />
                </AvGroup>
                <AvGroup>
                  ...
                  <AvField id="record-telephoneAgent" type="text" name="telephoneAgent" />
                </AvGroup>
                <AvGroup>
                  ...
                  <AvField id="record-passportAgent" type="text" name="passportAgent" />
                </AvGroup>
                <AvGroup>
                  ...
                  <AvField id="record-addressAgent" type="text" name="addressAgent" />
                </AvGroup>
